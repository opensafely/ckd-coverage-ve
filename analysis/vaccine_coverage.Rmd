...
data_processed = data_processed %>%
  mutate(
    ...
    dose_1_product = ifelse(
      ((is.na(pfizer_date_1) + is.na(astrazeneca_date_1) + is.na(moderna_date_1))>1) |
      (!is.na(covid_vacc_date_1) & is.na(pfizer_date_1) & is.na(astrazeneca_date_1) & is.na(moderna_date_1)),
      4,NA),
    ...
    dose_2_product = ifelse(
      ((is.na(pfizer_date_2) + is.na(astrazeneca_date_2) + is.na(moderna_date_2))>1) |
      (!is.na(covid_vacc_date_2) & is.na(pfizer_date_2) & is.na(astrazeneca_date_2) & is.na(moderna_date_2)),
      4,NA),
    ...
    dose_3_product = ifelse(
      ((is.na(pfizer_date_3) + is.na(astrazeneca_date_3) + is.na(moderna_date_3))>1) |
      (!is.na(covid_vacc_date_3) & is.na(pfizer_date_3) & is.na(astrazeneca_date_3) & is.na(moderna_date_3)),
      4,NA),
    ...
    dose_4_product = ifelse(
      ((is.na(pfizer_date_4) + is.na(astrazeneca_date_4) + is.na(moderna_date_4))>1) |
      (!is.na(covid_vacc_date_4) & is.na(pfizer_date_4) & is.na(astrazeneca_date_4) & is.na(moderna_date_4)),
      4,NA),
