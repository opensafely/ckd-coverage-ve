...
table_1 <- rbind(
  ...
  read_rds(here::here("output", "tables", "table1_VE_redacted_matched_all.rds")) %>% mutate(subgroup = "Matched (all)", subgroup_id = 2),
  read_rds(here::here("output", "tables", "table1_VE_redacted_unmatched_CKD3.rds")) %>% mutate(subgroup = "CKD3", subgroup_id = 3),
  read_rds(here::here("output", "tables", "table1_VE_redacted_unmatched_CKD4-5.rds")) %>% mutate(subgroup = "CKD4-5", subgroup_id = 4),
  read_rds(here::here("output", "tables", "table1_VE_redacted_unmatched_RRT.rds")) %>% mutate(subgroup = "RRT", subgroup_id = 5)
)
...
table_irr <- read_rds(here::here("output", "tables", "table_irr_redacted_unmatched_all.rds"))
...
read_in_subgroup_model = function(selected_subgroup="CKD3") {
  model = rbind(
    read_rds(here::here("output", "model", paste0("modelcox_tidy_reduced_unmatched_persontime_",outcome_list[1],"_",selected_subgroup,".rds"))) %>%
      mutate(outcome_clean = clean_list[1]),
    read_rds(here::here("output", "model", paste0("modelcox_tidy_reduced_unmatched_persontime_",outcome_list[3],"_",selected_subgroup,".rds"))) %>%
      mutate(outcome_clean = clean_list[3]),
    read_rds(here::here("output", "model", paste0("modelcox_tidy_reduced_unmatched_persontime_",outcome_list[4],"_",selected_subgroup,".rds"))) %>%
      mutate(outcome_clean = clean_list[4]),
    read_rds(here::here("output", "model", paste0("modelcox_tidy_reduced_unmatched_persontime_",outcome_list[5],"_",selected_subgroup,".rds"))) %>%
      mutate(outcome_clean = clean_list[5])
    ) %>% 
    mutate(model_group = paste0("Person-time"," (",model_name,")"))
...
create_subgroup_table = function(selected_subgroup="CKD3", subgroup_model_data) {
  ## Read in table of IRRs
  table_irr <- read_rds(here::here("output", "tables", paste0("table_irr_redacted_unmatched_",selected_subgroup,".rds")))
