...
model_persontime = rbind(
  ...
  mutate(model_group = "Person-time")
...
model_calendartime = rbind(
  ...
  mutate(model_group = "Calendar-time")
...
model_subset = subset(model, model_name=="fully adjusted" | model_group=="Matched")
model_subset$model_group = factor(model_subset$model_group, levels = c("Person-time", "Calendar-time", "Matched"))
