...
dir.create(here::here("output", "model", "VE_primary_summary"), showWarnings = FALSE, recursive=TRUE)
...
for (i in 1:length(outcome_list_sub)) {
  ...
  ## Save
  write_csv(merged_wide, here::here("output", "model", "VE_primary_summary", "covariate_summary_{selected_outcome}.csv"))
}
```
.