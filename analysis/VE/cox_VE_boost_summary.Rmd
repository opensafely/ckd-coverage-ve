...
model$term_midpoint[model$term=="15-126"] = max(postvaxcuts)+period_length/2
model$term_left[model$term=="15-126"] = max(postvaxcuts)
model$term_right[model$term=="15-126"] = max(postvaxcuts)+period_length
...
## Generate HR plot for 4 outcomes
