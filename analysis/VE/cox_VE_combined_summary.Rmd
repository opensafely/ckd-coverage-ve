...
##### Whole population - modified for publication - 0.05
```{r fig.width=12, fig.height=10}
generate_km_plot(surv_combined) + 
  scale_y_continuous(expand = expansion(mult=c(0,0.05))) +
  theme(legend.position = "right")
```

##### Whole population - modified for publication - 0.1
```{r fig.width=12, fig.height=10}
generate_km_plot(surv_combined) + 
...
##### Whole population - modified for publication - 0.15
```{r fig.width=12, fig.height=10}
generate_km_plot(surv_combined) + 
...
##### Matched population - modified for publication - 0.05
```{r fig.width=12, fig.height=10}
generate_km_plot(surv_combined) + 
  scale_y_continuous(expand = expansion(mult=c(0,0.05))) +
  theme(legend.position = "right")
...
##### Matched population - modified for publication - 0.1
```{r fig.width=12, fig.height=10}
generate_km_plot(surv_combined) + 
  scale_y_continuous(expand = expansion(mult=c(0,0.1))) +
  theme(legend.position = "right")
...
##### Matched population - modified for publication - 0.15
```{r fig.width=12, fig.height=10}
generate_km_plot(surv_combined) + 
  scale_y_continuous(expand = expansion(mult=c(0,0.15))) +
  theme(legend.position = "right")
