...
period_length_boost = postvaxcuts_boost[2]-postvaxcuts_boost[1]
...
collate_rounded_km = function(data_tte_primary, data_tte_boost) {
  ...
  surv_combined$outcome_clean <- recode_factor(surv_combined$outcome_clean, 
                                               ...
                                               `COVID-related hospitalisation` = "COVID-19 hosp.",
                                               `COVID-related death` = "COVID-19 death") 
...
d$outcome[d$outcome=="Positive SARS-CoV-2 test"] = "SARS-CoV-2+"
d$outcome[d$outcome=="COVID-related hospitalisation"] = "COVID-19 hosp."
d$outcome[d$outcome=="COVID-related death"] = "COVID-19 death"
...
ggplot(data = d) +
  ...
  #scale_x_continuous(breaks=c(0,14,70,126,182), expand = c(0, 0)) +
  scale_colour_manual(values = c("#993404", "#0570b0", "#045a8d", "#023858")) +
  labs(
    y="Hazard ratio (95% CI)",
    x="",
    colour=NULL,
