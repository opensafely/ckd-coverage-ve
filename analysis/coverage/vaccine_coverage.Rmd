...
collated$`Cumulative probability` = c(round(max(subset(km_collated, dose==1)$cum.in_rounded)*100,1),
                      round(max(subset(km_collated, dose==2)$cum.in_rounded)*100,1),
                      round(max(subset(km_collated, dose==3)$cum.in_rounded)*100,1),
                      round(max(subset(km_collated, dose==4)$cum.in_rounded)*100,1))
