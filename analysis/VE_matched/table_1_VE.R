...
table1$Group[table1$Group=="multimorb"] = "Comoborbidity count (non-CKD)"

# Other
table1$Group[table1$Variable %in% c("CKD diagnostic code", "Dialysis", "Kidney transplant", "CKD stage 3-5 code")] = "Clinical (CKD-related)"
table1$Group[table1$Variable %in% c("Clinically extremely vulnerable", "Care home resident", "Health and social care worker", "End of life care", "Housebound", 
